...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'mail@iqbalrifai.eu.org',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/Drive',
  ...
  protectedRoutes: ['/Private', '/upload'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:mail@iqbalrifai.eu.org',
